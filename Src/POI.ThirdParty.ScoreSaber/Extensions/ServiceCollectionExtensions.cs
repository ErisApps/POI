...
public static class ServiceCollectionExtensions
{
	...
	///  <remark>
	///		Make sure that the <see cref="POI.Core.Services.IConstantsCore">IConstants</see> and <see cref="Microsoft.Extensions.Logging.ILogger">ILogger</see> interfaces have been
